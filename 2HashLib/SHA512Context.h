...
public:
	...
	SHA512Context(const SHA512Context &orig);
	SHA512Context& operator=(const SHA512Context &orig) = delete;
	SHA512Context(SHA512Context &&orig);
	SHA512Context& operator=(SHA512Context &&orig) = delete;
...
private:
	static const unsigned int hashSize = 64U;
	...
	*/
	std::vector<unsigned char> * sha512Ctx = nullptr;
};